package com.test.spring.batch.cloud.aws.s3;
...
public class SpringCloudS3 {
    ...
    public void downloadS3Object(String s3Url) throws IOException {
        ...
        Files.createDirectories(Paths.get(System.getProperty("user.home") + "/data/input/"));
        
        System.out.println("ls before: " + Paths.get(System.getProperty("user.home") + "/data/input/"));
        
        File downloadedS3Object = new File(System.getProperty("user.home") + "/data/input/" + resource.getFilename());
